...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest vibetest.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Создание файла проекта (`vibetest.client.esproj`).
